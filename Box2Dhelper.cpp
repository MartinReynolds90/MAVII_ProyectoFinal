...
//-------------------------------------------------------------
b2Body* Box2Dhelper::CreateDynamicBody(b2World* phyWorld)
{
	// Declaramos el body
	b2Body* body;
...
//-------------------------------------------------------------
b2Body* Box2Dhelper::CreateStaticBody(b2World* phyWorld)
{
	// Declaramos el body
	b2Body* body;
...
//-------------------------------------------------------------
b2Body* Box2Dhelper::CreateKinematicBody(b2World* phyWorld)
{
	// Declaramos el body
	b2Body* body;
...
//-------------------------------------------------------------
b2FixtureDef Box2Dhelper::CreateRectangularFixtureDef(float sizeX, float sizeY, float density, float friction, float restitution)
{
...
//-------------------------------------------------------------
b2FixtureDef Box2Dhelper::CreateCircularFixtureDef(float radius, float density, float friction, float restitution)
{
...
//-------------------------------------------------------------
b2FixtureDef Box2Dhelper::CreatePolyFixtureDef(b2Vec2* v, int n, float density, float friction, float restitution)
{
...
//-------------------------------------------------------------
b2FixtureDef Box2Dhelper::CreateTriangularFixtureDef(b2Vec2 c, float h, float density, float friction, float restitution)
{
	b2Vec2 verts[3];
	verts[0].x = -h / 2;
	verts[0].y = -h / 2;
...
//-------------------------------------------------------------
b2Body* Box2Dhelper::CreateRectangularDynamicBody(b2World* phyWorld, float sizeX, float sizeY, float density, float friction, float restitution)
{
...
//-------------------------------------------------------------
b2Body* Box2Dhelper::CreateRectangularKinematicBody(b2World* phyWorld, float sizeX, float sizeY)
{
	...
	//-------------------------------------------------------------
b2Body* Box2Dhelper::CreateRectangularStaticBody(b2World* phyWorld, float sizeX, float sizeY)
{
	...
	//-------------------------------------------------------------
b2Body* Box2Dhelper::CreateCircularDynamicBody(b2World* phyWorld, float radius, float density, float friction, float restitution)
{
	b2Body* body = CreateDynamicBody(phyWorld);
...
//-------------------------------------------------------------
b2Body* Box2Dhelper::CreateCircularKinematicBody(b2World* phyWorld, float radius)
{
	b2Body* body = CreateKinematicBody(phyWorld);
...
//-------------------------------------------------------------
b2Body* Box2Dhelper::CreateCircularStaticBody(b2World* phyWorld, float radius)
{
	b2Body* body = CreateStaticBody(phyWorld);
	b2FixtureDef cir = CreateCircularFixtureDef(radius, 0.0f, 0.0f, 0.0f);
	body->CreateFixture(&cir);
...
//-------------------------------------------------------------
b2Body* Box2Dhelper::CreateTriangularDynamicBody(b2World* phyWorld, b2Vec2 center, float h, float density, float friction, float restitution)
{
	b2Body* body = CreateDynamicBody(phyWorld);
...
//-------------------------------------------------------------
b2Body* Box2Dhelper::CreateTriangularKinematicBody(b2World* phyWorld, b2Vec2 center, float h)
{
	b2Body* body = CreateKinematicBody(phyWorld);
...
//-------------------------------------------------------------
b2Body* Box2Dhelper::CreateTriangularStaticBody(b2World* phyWorld, b2Vec2 center, float h)
{
	b2Body* body = CreateStaticBody(phyWorld);
	b2FixtureDef tri = CreateTriangularFixtureDef(center, h, 0.0f, 0.0f, 0.0f);
	body->CreateFixture(&tri);
...
//-------------------------------------------------------------
b2Body* Box2Dhelper::CreatePolyDynamicBody(b2World* phyWorld, b2Vec2* v, int n, float density, float friction, float restitution)
{
	b2Body* body = CreateDynamicBody(phyWorld);
...
//-------------------------------------------------------------
b2Body* Box2Dhelper::CreatePolyKinematicBody(b2World* phyWorld, b2Vec2* v, int n)
{
	b2Body* body = CreateKinematicBody(phyWorld);
...
//-------------------------------------------------------------
b2Body* Box2Dhelper::CreatePolyStaticBody(b2World* phyWorld, b2Vec2* v, int n)
{
	b2Body* body = CreateDynamicBody(phyWorld);
	b2FixtureDef tri = CreatePolyFixtureDef(v, n, 0.0f, 0.0f, 0.0f);
	body->CreateFixture(&tri);
...
//-------------------------------------------------------------
b2DistanceJoint* Box2Dhelper::CreateDistanceJoint(b2World* phyWorld, b2Body* first, b2Vec2 anchorFirst, b2Body* second, b2Vec2 anchorSecond,
...
//-------------------------------------------------------------
b2RevoluteJoint* Box2Dhelper::CreateRevoluteJoint(b2World* phyWorld, b2Body* base, b2Vec2 anchorBase, b2Body* second,
...
//-------------------------------------------------------------
b2PrismaticJoint* Box2Dhelper::CreatePrismaticJoint(b2World* phyWorld, b2Body* base, b2Vec2 anchorBase, b2Body* second,
...
//-------------------------------------------------------------
b2PulleyJoint* Box2Dhelper::CreatePulleyJoint(b2World* phyWorld, b2Body* first, b2Vec2 anchorFirst, b2Vec2 worldAnchor1,
...
// Una Pulley Joint entre dos cuerpos
//-------------------------------------------------------------
b2GearJoint* Box2Dhelper::CreateGearJoint(b2World* phyWorld, b2Body* first, b2Body* second,
...
//-------------------------------------------------------------
b2MouseJoint* Box2Dhelper::CreateMouseJoint(b2World* phyWorld, b2Body* second, float maxForce)
{
