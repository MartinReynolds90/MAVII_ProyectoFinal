...
void NivelDos::load(b2World* phyWorld) {
    firstObstacleBody = Box2Dhelper::CreateRectangularStaticBody(phyWorld, 1, 45);
    firstObstacleBody->SetTransform(b2Vec2(100.0f, 180.0f), 0.0f);
    secondObstacleBody = Box2Dhelper::CreateRectangularDynamicBody(phyWorld, 2, 45, 1.0f, 0.5f, 0.3f);
    secondObstacleBody->SetTransform(b2Vec2(50.0f, 190.0f), 0.0f);
    thirdObstacleBody = Box2Dhelper::CreateRectangularDynamicBody(phyWorld, 3, 5, 1.0f, 0.5f, 0.3f);
    thirdObstacleBody->SetTransform(b2Vec2(160.0f, 50.0f), 0.0f);
    fourthObstacleBody = Box2Dhelper::CreateCircularKinematicBody(phyWorld, 7.0);
    fourthObstacleBody->SetTransform(b2Vec2(50.0f, 25.0f), 0.0f);
    fifthObstacleBody = Box2Dhelper::CreateTriangularStaticBody(phyWorld, b2Vec2(45.0, 45.0), 4.0f);
    fifthObstacleBody->SetTransform(b2Vec2(60.0f, 70.0f), 0.9f);
...
void NivelDos::unload(b2World* phyWorld) {//DESTRUYE CADA ELEMENTO DEL NIVEL<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
